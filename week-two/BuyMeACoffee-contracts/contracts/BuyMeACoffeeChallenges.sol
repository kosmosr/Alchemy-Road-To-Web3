...
contract BuyMeACoffeeChallenges {
    ...
    constructor() {
        ...
        // init withdraw address is owner
    ...
    function buyLargeCoffee(string memory _name, string memory _message) public payable {
        require(msg.value == 0.003 ether, "value must be 0.003 ether");
    ...
    function setWithdrawAddress(address newWithdrawAddress) public {
